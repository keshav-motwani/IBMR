...
RESULT_PATH = "results/simulations_unstructured_splatter_X_and_Beta"
...
for (i in 1:chunk_size) {
  ...
  system.time({result = evaluate_parameters(current_parameters, generate_data_unstructured_splatter_X_and_Beta)})
