...
RESULT_PATH = "final_results/simulations_random_X_and_structured_Beta_updated_again_more_fine_more_nonzero_more_fine_sigma1_catmap62_changeNprange"
...
defaults = list(
  ...
  sigma = 1, # sd of normal distribution for sampling coefficients
  rank = "int",
