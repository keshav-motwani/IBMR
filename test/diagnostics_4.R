...
check_KKT_IBMR(Y_matrix_list, X_list, X_list, 0.01, 0.5, test_Newton$alpha, test_Newton$Beta, test_Newton$Gamma_list)
check_KKT_IBMR(Y_matrix_list_fine, X_list, X_list, 0.01, 0.5, test_fine_Newton$alpha, test_fine_Newton$Beta, test_fine_Newton$Gamma_list)

par(mfrow = c(2, 2))

plot(test$Beta, test_Newton$Beta)
abline(0, 1)
